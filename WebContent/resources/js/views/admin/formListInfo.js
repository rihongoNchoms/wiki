...
(function() {
	...
	function FormListInfo() {
		...
		// Test
		function _copyInitScript() {
			
			// 화면리스트 중 체크한 항목에 대해서 
			// .js 파일의 init 스크립트를 클립보드에 복사한다. -> 복사한 내용을 스크립트 파일로 생성 가능한지도 파악하기
			
			var copyText = "ABCDEFGABCDEFGABCDEFGABCDEFG";
			
			$("#clipBoard").css('display','block').val(copyText).select();
			
			var textRange;
			textRange = document.execCommand("copy");
			console.log("textRange ... test");
