	...
	<div class="ax-wrap">
		<div class="ax-layer">
			<div class="ax-col-12">
				<div class="ax-unit">
					<div class="ax-logo">
						<a href=""><span class="logo-img"><i class="axi axi-axisj"></i></span><span class="logo-txt">PROJECT MAIN</span></a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="ax-col-4">
				...
				<div class="ax-unit">
					<ul class="ax-loginfo" id="ax-loginfo">
						...
						<!-- 로그인 사용자 계정명을 화면에 출력 -->
						<li class="account"><a href="#"><%=name%></a></li> 
						<li class="btns"><a href="/j_spring_security_logout" class="AXButton"><i class="axi axi-power-off"></i> 로그아웃</a></li>
					</ul>
					<div class="mx-loginfo"><a id="mx-loginfo-handle" class="mx-menu-button"><i class="axi axi-bars"></i></a></div>
				</div>
				</sec:authorize>
