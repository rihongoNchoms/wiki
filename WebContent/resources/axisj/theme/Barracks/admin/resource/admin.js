...
var sideMenu_data = [
    {_id: "m01", label: '<i class="axi axi-windows"></i> aaa', url: "index.html", target: "_self"},
    {_id: "m02", label: '<i class="axi axi-asterisk"></i> bbb', url: "content.html", target: "_self"},
    {_id: "m03", label: '<i class="axi axi-columns"></i> ccc', url: "content-1.html", target: "_self"},
    {_id: "m04", label: '<i class="axi axi-pagelines"></i> ddd', url: "content-2.html", target: "_self"},
    {_id: "m05", label: '<i class="axi axi-sitemap"></i> eee', url: "content.html", target: "_self"},
    {_id: "m06", label: '<i class="axi axi-archive"></i> fff', url: "content.html", target: "_self"}
];
